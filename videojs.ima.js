...
(function(vjs) {
  ...
  var ImaPlugin = function(player, options, readyCallback) {
    ...
    var onAdsLoaderError_ = function(event) {
      ...
      document.getElementById("ima-sample-console").innerHTML = document.getElementById("ima-sample-console").innerHTML + '<br/>' + 'AdsLoader error: ' + event.getError();
    ...
    var onAdError_ = function(adErrorEvent) {
      ...
      document.getElementById("ima-sample-console").innerHTML = document.getElementById("ima-sample-console").innerHTML + '<br/>' + 'Ad error: ' + adErrorEvent.getError();
