      ...
      (function(state) {
        ...
        if (state !== player.ads.state) {
          ...
          if (settings.debug) {
            ...
            document.getElementById("ima-sample-console").innerHTML = document.getElementById("ima-sample-console").innerHTML + '<br/>' + 'ads'+ player.ads.triggerevent + ' triggered: ' + state + ' -> ' + player.ads.state;
          }
        }
